...
class Menu:
	def __init__(self):
		...
		self.buttons = [Button("SOLO", (winWidth / 4) - (self.button_size[0] / 2), (winHeight / 2) - (self.button_size[1] / 2), self.button_size[0], self.button_size[1], winHeight * 0.085),
                  Button("1 VS 1", (winWidth / 4 * 2) - (self.button_size[0] / 2), (winHeight / 2) - (self.button_size[1] / 2), self.button_size[0], self.button_size[1], winHeight * 0.085),
                  Button("CUSTOM", (winWidth / 4 * 3) - (self.button_size[0] / 2), (winHeight / 2) - (self.button_size[1] / 2), self.button_size[0], self.button_size[1], winHeight * 0.085)]
